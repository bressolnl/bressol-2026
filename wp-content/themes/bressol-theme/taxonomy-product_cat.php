...
if ($term_label === '') {
    $term_label = __('deze selectie', 'bressol-theme');
}
...
$intro_fallback = sprintf(
    __('Een verfijnde selectie rond %s, zorgvuldig gekozen voor momenten met karakter.', 'bressol-theme'),
    $term_label
);
$longform_fallback = sprintf(
    __('Binnen %s vind je producten met een rustige mediterrane signatuur. We selecteren op herkomst, ambacht en balans, zodat je eenvoudig kunt combineren.', 'bressol-theme'),
    $term_label
);
...
<section class="bressol-section bressol-trust">
    <div class="bressol-container">
        ...
        <ul class="bressol-trust-bar">
            <li><?php esc_html_e('Herkomst met aandacht', 'bressol-theme'); ?></li>
    ...
    <div class="bressol-container">
        ...
        <div class="bressol-grid">
            <article class="bressol-card">
                ...
                <p class="bressol-card__meta"><?php esc_html_e('Selecties met duidelijke herkomst en ambachtelijke signatuur.', 'bressol-theme'); ?></p>
            </article>
            <article class="bressol-card">
                <h3 class="bressol-card__title"><?php esc_html_e('Kwaliteit & selectie', 'bressol-theme'); ?></h3>
                <p class="bressol-card__meta"><?php esc_html_e('Gekozen op smaakbalans en een consistente stijl.', 'bressol-theme'); ?></p>
            </article>
            <article class="bressol-card">
                <h3 class="bressol-card__title"><?php esc_html_e('Service & levering', 'bressol-theme'); ?></h3>
                <p class="bressol-card__meta"><?php esc_html_e('Zorgvuldige service en begeleiding wanneer gewenst.', 'bressol-theme'); ?></p>
            </article>
        </div>
    </div>
</section>
    ...
    <div class="bressol-container">
        ...
        <?php if ($woo_active) : ?>
            ...
            <?php else : ?>
                ...
                <p class="bressol-empty"><?php esc_html_e('Er zijn op dit moment geen producten zichtbaar in deze selectie.', 'bressol-theme'); ?></p>
                <p>
            ...
            <?php endif; ?>
        <?php else : ?>
            <p class="bressol-empty"><?php esc_html_e('Het overzicht is tijdelijk niet beschikbaar. Laat je adviseren voor een selectie op maat.', 'bressol-theme'); ?></p>
            <p>
                <a class="bressol-link" href="<?php echo esc_url($advies_link); ?>">
                    <?php esc_html_e('Start met advies', 'bressol-theme'); ?>
                </a>
